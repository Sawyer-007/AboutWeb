...
function draw() {
	...
	canvas100.drawImage(canvas.canvas, avatarX, avatarY, avatarD, avatarD, 0, 0, 120, 120);
	canvas50.drawImage(canvas.canvas, avatarX, avatarY, avatarD, avatarD, 0, 0, 80, 80);
	canvas30.drawImage(canvas.canvas, avatarX, avatarY, avatarD, avatarD, 0, 0, 50, 50);
}
